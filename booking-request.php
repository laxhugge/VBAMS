                        ...
                        <div class="client-address">
                            ...
                            <div class="client-address-form">
                                <form action="" method="post">
                                   ...
                                   <input class="form-control" type="text" placeholder="Enter address" name="pickuploc" required="true">
                                    <label class="form-label">Vehicle no</label>
                                  <input class="form-control" type="text" required="true" name="pickupdate">
